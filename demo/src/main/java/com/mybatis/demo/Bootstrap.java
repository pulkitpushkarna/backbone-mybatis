...
//        jdbcTemplate.update("DROP TABLE IF EXISTS student ");
        ...
        jdbcTemplate.update("create table if not exists faculty(" +
        ...
        jdbcTemplate.update("create table if not exists persistent_logins(" +
        ...
        jdbcTemplate.update("create table if not exists student(" +
                ...
                ")");
        jdbcTemplate.update("create table if not exists student_class(" +
